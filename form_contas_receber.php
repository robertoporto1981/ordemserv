  ...
  <div class="form-row">
    <div class="form-group col-md-2">
      <label>Data do Vencimento:</label>
          ...
          <input type="date" name="datalanc" value="<?php echo $ano ?>-<?php echo $mes ?>-<?php echo $dia; ?>" class="form-control "maxlength="10" size="12" required>
    </div>      
  
  <div class="form-group col-md-3">
      <label>Cliente: <?php echo $codigo_cliente ?></label>
      	       
        <input type ="text" name="cliente" class="form-control" value="<?php echo $cliente ?>"><a href="cons_clientes_receber.php">  <img src="images/lupa.png" alt="Smiley face" width="25" height="20" align="absbottom"></a>
