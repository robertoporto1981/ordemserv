...
$sql = "DELETE contasapagar, entradasaidas FROM contasapagar LEFT JOIN entradasaidas ON contasapagar.codoper = entradasaidas.documento WHERE contasapagar.codoper = '$CODOPER'";
...
.then((value) => {
             window.location.href='consulta_pagar.php';
});
