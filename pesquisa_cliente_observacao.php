...
$sql = "select * from clientes where observ like ('%$observacao%') ORDER BY observ asc";
...
while($registro = mysqli_fetch_assoc($consulta)){
		...
		echo "Observacao:<input type='text' name ='observ' maxlength='80' id='formulario' value ='".$registro['observ']."' size='80'>"; 
