    ...
    <form action="./" id="formulario" method="post">	 	 	   
        ...
        <div class="form-row">		                     
            <div class="form-group col-md-2">                         <td>
                    ...
                    <input type="text" id="formulario" maxlength="8" class="form-control" name ="dataentr" value =<?php echo $data; ?> size="8"></td>        
            </div>                 
            <div class="form-group col-md-2">		             
                <label>Hora Entrada:
                </label>                         
                <input type="text" id="formulario" maxlength="8"  class="form-control" name ="horacheg"  value =<?php echo $hora; ?> size="8">                       
            </div>                      
            <div class="form-group col-md-2">             		
                <label>Previsao Saida:
                </label>                                 
                <input type="text" id="formulario" maxlength="10" class="form-control" name ="prevsaid" size="10">    	   
            </div>                 
        ...
        <div class="form-row">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">                 
                    ...
                    <input type ="text" value="<?php echo $email ?>" id="formulario" class="form-control" name = "email" autocomplete="off">
                </div>
            </div>
            <!--Fim do form-row -->     	
            </table>
            <div class="form-row">	
                <table border="2">      
                    <div class="form-group col-md-4">		         
                        ...
                        <input type="text" id="formulario" name="equipamento" class="form-control" size="20" maxlength="20"  autocomplete="off" required>      
                    </div>               
                    <div class="form-group col-md-3">         
                        <label>Modelo:
                        </label>        
                        <input type ="text" id="formulario" name = "modelo" class="form-control" maxlength="20" size = "20"  autocomplete="off" required>
                    </div>  
                    <div class="form-group col-md-3">		
                        <label>Marca:
                        </label>      
                        <input type ="text" id="formulario" class="form-control" name ="marca" maxlength="15" size = "15" autocomplete="off" required>	 
                    </div>
            </div>
            <!--Fim do form-row -->
            <div class="form-row">    
                <div class="form-group col-md-3">		     
                    ...
                    <input type ="text" id="formulario" name ="serial" class="form-control" maxlength="25" autocomplete="off" required>    
                </div>    
                <div class="form-group col-md-3">		    
                    <label>Acessorios:
                    </label>                     
                    <input type ="text" id="formulario" class="form-control" name ="acessorios" maxlength="25" autocomplete="off">        
                </div>
            ...
            <div class="form-group col-md-4">
                ...
                <label>Detalhes e observações:</label>
                    ...
                    <input type ="text" id="formulario" class="form-control" name ="detalhes" size = "99" autocomplete="off" required></td>
            </div>                
