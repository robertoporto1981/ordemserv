...
<?php $_SESSION['pagina']= "cons_clientes_receber.php"; ?>
...
<h1>Consulta cliente</h1>
	...
	<form method="POST" action="form_contas_receber.php">
...
while ( $registro = mysqli_fetch_assoc( $consulta ) ) {
				...
				//echo '<td id="campos"><a href="cadastro_receber.php?busca=' . $registro["nome"] . '"#><input type="submit" value="SELECIONAR"' . $registr´['nome'] . '</td>';
				
                echo '<td id="campos"><a href="form_contas_receber.php?busca=' . $registro["nome"] .'&cod='. $registro["cod"].'"#><input type="submit" value="SELECIONAR"' . $registr´['nome'] . '</td>';
