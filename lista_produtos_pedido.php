...
while($registro = mysqli_fetch_assoc($consulta)){
    ...
    //echo '<td id="campos"><a href="pedido_roberto.php?busca='.$registro["cod"].'"#><input type="submit" value="SELECIONAR"</td>';

    	echo '<td id="campos"><a href="pedido_roberto.php?busca='.$registro["cod"].'"#><img src="images/inserir.png" width="30px" height="20px"/></td>';
    	...
    	echo '<td id="campos">'.$registro["unidade"].'</td>';
  		...
  		echo '<td id="campos">R$'.$registro["preco_venda"].'</td>';
