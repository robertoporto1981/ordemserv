...
?>
  ...
  <body>
      ...
      <h2>ORDEM DE SERIVÇO Nº <?php echo $numeroord ?> <h2>
              ...
              <h3>CPF/CNPJ: <?php $cpjcnpj ?> Bairro:<?php echo $bairro ?> Cidade: <?php echo $cidade ?> UF:
                  <?php echo $uf ?> CEP:<?php echo $cep ?></h3>
              ...
              <p>O(s) equipamento(s) nao retirados apos 90 dias da comunicacao ao cliente, sera(ao) considerados(s)
                  abandonados(s), em consequencia serao incorporados como propriedade da empresa e vendidos para
                  ressarcimento das
  ...
  <body>
      ...
      <div id="comprovante">
          ...
          <h1>COMPROVANTE DE ENTRADA - OS NUMERO: <?php echo $numeroord ?> Hora:<?php echo $horacheg ?>
              Data:<?php echo $dataentr ?>
